...
main = do 
  ...
  (_,_,herr) <- readProcessWithExitCode (fromJust (showE "sox")) (dirT ++ ["RhythmicAirBells.flac", "reverb", "100", "speed", "0.5", "tempo", "2", "reverb", "-w", "70", "vol", "5", "reverb", "60", "reverb", "-w", "sinc", "200-600", "vol", "5", "reverb", "70"]) ""
  print herr
